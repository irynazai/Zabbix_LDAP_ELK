...
variable "subnet" {
    description             = "The name or self_link of the server subnetwork to attach this interface to. The subnetwork must exist in the same region this instance will be created in. Either network or subnetwork must be provided."
    default                 = "subnet"
}
