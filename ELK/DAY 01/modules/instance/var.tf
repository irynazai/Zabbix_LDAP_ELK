...
variable "network" {
    description 			= "The name of the elk network."
    default     			= "vpc-network"
}


variable "subnet" {
    description 			= "The name or self_link of the elksubnetwork to attach this interface to. The subnetwork must exist in the same region this instance will be created in. Either network or subnetwork must be provided."
    default     			= "subnet"
}


variable "elk_subnet_cidr" {
    description 			= "The elk IP range od address to assign to the instance. If empty, the address will be automatically assigned."
    default     			= "10.5.2.0/24"
}
...
variable "elk_tags" {
  description 				= "A tags of elk host."
  default     				= ["elk-tag"]    
}
